            ...
            if i + j < len(lista_productos):
                with cols[j]:
                    ...
                    for ruta in posibles_rutas:
                        # SOLUCIÓN DEL ERROR: Validamos que 'ruta' exista y no sea None
                    ...
                    if ruta_img:
                        ...
                        for ruta_logo in posibles_logos:
                            # SOLUCIÓN DEL ERROR: Validamos también la ruta del logo
                    ...
                    # HTML en una sola línea para evitar errores de renderizado de Streamlit
